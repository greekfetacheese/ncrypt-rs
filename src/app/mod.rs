    ...
    fn update(&mut self, ctx: &Context, _frame: &mut eframe::Frame) {
        ...
        window_frame(ctx, frame, "nCrypt 1.0.0", |ui| {
            ...
            SidePanel::right("right_panel")
                ...
                .resizable(false)
                .frame(
                    frame.clone().inner_margin(Margin { left: 20, right: 0, top: 100, bottom: 0 })
                )
                .show_inside(ui, |ui| {
            ...
            SidePanel::left("left_panel")
                ...
                .resizable(false)
                .frame(
                    frame.clone().inner_margin(Margin { left: 0, right: 0, top: 100, bottom: 0 })
                )
                .show_inside(ui, |ui| {
            ...
            CentralPanel::default()
                .frame(
                    frame.inner_margin(Margin { left: 0, right: 0, top: 30, bottom: 0 })
                )
                .show_inside(ui, |ui| {
